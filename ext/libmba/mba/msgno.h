...
extern struct msgno_entry msgno_builtin_codes[];
extern char msgno_buf[];
extern int msgno_buf_idx;
extern int msgno_append(const char *src, int n);
extern int msgno_loc0(const char *loc0, const char *loc1);
extern int msgno_mmsg0(const char *fmt, ...);
extern int msgno_mmno0(int msgno);
extern int msgno_mmnf0(int msgno, const char *fmt, ...);
extern int msgno_amsg0(const char *fmt, ...);
extern int msgno_amno0(int msgno);
extern int msgno_amnf0(int msgno, const char *fmt, ...);
extern int msgno_hdlr_stderr(const char *fmt, ...);

extern int (*msgno_hdlr)(const char *fmt, ...);
extern int msgno_add_codes(struct msgno_entry *lst);
extern const char *msgno_msg(int msgno);
